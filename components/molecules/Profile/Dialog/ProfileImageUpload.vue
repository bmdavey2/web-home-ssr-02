...
.card
  .card-content.p-0.py-3.px-5.has-text-centered
    .is-size-4.has-text-secondary.has-text-weight-medium.mt-5 Upload Profile Image
    .is-size-6.mb-5.has-text-grey Recommended image size is 300 x 300px

    b-upload(v-model="file" drag-drop accept="image/*")
      ...
      .content-image(v-if="url")
        img(:src="url" width="291" height="291")
