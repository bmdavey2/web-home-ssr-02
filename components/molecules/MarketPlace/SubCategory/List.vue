<template lang="pug">
.xm-marketplace-sub-category-list(v-if="!isRetrieving")
...
export default {
  name: 'XMMarketPlaceSubCategoryList',
    ...
    async doRetrieveProducts() {
      ...
      try {
        const { data } = await this.$apollo.query({
          ...
          variables: {
            category: this.$route.params?.sub || null,
...
.xm-marketplace-sub-category-list::v-deep {
  padding-bottom: 50px;
