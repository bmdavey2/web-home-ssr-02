<template lang="pug">
.xp-articles-sub-category.py-6
  .container
    XMArticlesSubCategoryBreadcrumbs
    h1 {{ title }} Articles
    XMArticlesSubCategoryFilter(@DoUpdateSortByFilter="sortBy = $event")
...
import XMArticlesSubCategoryBreadcrumbs from '~/components/molecules/Articles/SubCategory/Breadcrumbs'
import XMArticlesSubCategoryFilter from '~/components/molecules/Articles/SubCategory/Filter'
import XMArticlesCategoryList from '~/components/molecules/Articles/Category/List'

export default {
  name: 'XPArticlesSubCategory',
  components: { XMArticlesSubCategoryBreadcrumbs, XMArticlesSubCategoryFilter, XMArticlesCategoryList },
  props: {
    parentTitle: String,
    title: String,
  },
  ...
  methods: {
    async doRetrieveCategories() {
      try {
        ...
        if (this.parentCategories.includes(this.parentTitle)) {
          this.categories = categories.filter((category) => {
            return category?.parent === this.parentTitle
          })
          return
        }
...
.xp-articles-sub-category::v-deep {
