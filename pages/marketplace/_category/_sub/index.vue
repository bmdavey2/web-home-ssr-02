<template lang="pug">
XPMarketPlaceSubCategory(:parent-title="parentTitle", :title="title")
</template>

<script>
import XPMarketPlaceSubCategory from '~/components/pages/MarketPlace/SubCategory'
export default {
  components: { XPMarketPlaceSubCategory },
  computed: {
    title() {
      const url = this.$route.params?.sub
